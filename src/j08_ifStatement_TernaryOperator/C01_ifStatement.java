...
public class C01_ifStatement {
    public static void main(String[] args) {
        ...
        int ismlYas=40;
        if (krmYas==ismlYas) {
            System.out.println("aynı yasadasınız güzel insanlar");
        ...
        if (krmYas+ismlYas >100) {
            System.out.println("kerm bey ve isml bey yaşları toplamı 100 den büyük");
        }
        /*
        Bağımsız if statement yapıları sadece kendi scop(kapsamlarını) run eder.
        Birden fasla bağımsız if statement yapıları hepsinin body çalışabileceği gibi hiçbirisinin body de çalışmayabilir
         */
        /*
         int krmYas = 45;
        int ismlYas = 63;
