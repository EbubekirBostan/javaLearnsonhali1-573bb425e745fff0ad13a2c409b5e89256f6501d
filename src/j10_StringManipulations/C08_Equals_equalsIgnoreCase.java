...
String str2="merhaba ";
        ...
        String s1="songul hanım";// Strin pool->gömlek cebi->kolay cıkan para
        String s2="songul hanım";// Strin pool->gömlek cebi->kolay cıkan para
        ...
        System.out.println(s1==s2);//true// eşit eşit herşeyine bakar, karşılaştırma yapar
