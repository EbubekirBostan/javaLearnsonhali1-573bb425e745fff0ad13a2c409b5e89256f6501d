...
public class C01_Constructor {
    ...
    3- eğer parametreli constructor create edildiğinde java default consu ezer(siler)
    4- cons. return type olmaz method'dan ayıran özelliğidir
    5-Class oluştuğunda jjava default cons. kendi create eder.
     */
    String str;//instance variable->obje variable
