...
public class C01_HashSet {
     ...
     */
        ...
        //set remove() istenen elemanı siler
        System.out.println("hs1.remove(\"asıktır\") = " + hs1.remove("asıktır"));//hs1.remove("asıktır") = false
        System.out.println("hs1.remove(\"Asıktır\") = " + hs1.remove("Asıktır"));//hs1.remove("Asıktır") = true
        ...
        System.out.println("hs2.contains(\"Basarı\") = " + hs2.contains("Basarı"));//hs2.contains("Basarı") = true

        System.out.println("hs2.contains(\"JavaNazz\") = " + hs2.contains("JavaNazz"));//hs2.contains("JavaNazz") = false
