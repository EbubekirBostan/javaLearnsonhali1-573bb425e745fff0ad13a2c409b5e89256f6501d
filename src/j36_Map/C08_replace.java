...
public class C08_replace {
    public static void main(String[] args) {
        ...
        //map.replace();->Girilen value değeri  ilgili key de update edilir eski değeri return eder.
        ...
        System.out.println("hm = " + hm);//hm = {Saturn=300 Euro, Ebay=234 Euro, Apple store=333 Euro,
        // MediaMarkt=183 Euro, Amazon=314 Euro, Vatan=111 Euro}
        System.out.println("hm.replace(\"sefil\",\"bekir\") = " + hm.replace("sefil", "bekir"));//null
